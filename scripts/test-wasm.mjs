...
const lettering = await readFile(new URL('../tests/data/catwhale-small-text.png', import.meta.url));
const letteringSvg = convert_image(lettering, 512, false);
assert.match(letteringSvg, /data-compact-ink=/);
assert.doesNotMatch(letteringSvg, /<mask|\smask=|<image\b|<text\b/);
