 ...
 */
	...
	.text
.LATAN_2__routine_start___svml_atan2f16_z0_0:
...
..LATANN__svml_atan2f16.0:

.LATAN_2__routine_start___svml_satan2_cout_rare_internal_1:
...
..LATANN__svml_satan2_cout_rare_internal.1:
...
__satan2_la_CoutTab:
	...
	.size	__satan2_la_CoutTab,2008
      ...
      .text
      .align 16
      .globl picvec_svml_atan2f16
picvec_svml_atan2f16:
      pushq %rbx
      movq %rdx, %rbx
      vmovups (%rdi), %zmm0
      vmovups (%rsi), %zmm1
      call __svml_atan2f16
      vmovups %zmm0, (%rbx)
      vzeroupper
      popq %rbx
      ret
