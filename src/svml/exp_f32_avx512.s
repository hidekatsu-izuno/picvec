 ...
 */
	...
	.text
.LE32_2__routine_start___svml_expf16_z0_0:
...
..LE32N__svml_expf16.0:

.LE32_2__routine_start___svml_sexp_cout_rare_internal_1:
...
..LE3253:
        ...
        movss     (%rdi), %xmm9
        movss     .LE32_2il0floatpacket.52(%rip), %xmm0
        movl      %eax, -12(%rsp)
        comiss    %xmm9, %xmm0
        jb        .LE32BL_2_10


        comiss    .LE32_2il0floatpacket.53(%rip), %xmm9
        jb        .LE32BL_2_9


        movss     .LE32_2il0floatpacket.55(%rip), %xmm0
        movaps    %xmm9, %xmm6
        mulss     %xmm9, %xmm0
        comiss    .LE32_2il0floatpacket.64(%rip), %xmm9
        movss     %xmm0, -24(%rsp)
        movss     -24(%rsp), %xmm1
        movss     .LE32_2il0floatpacket.56(%rip), %xmm2
        movss     .LE32_2il0floatpacket.63(%rip), %xmm7
        addss     %xmm2, %xmm1
        movss     %xmm1, -20(%rsp)
        movss     -20(%rsp), %xmm3
        movss     .LE32_2il0floatpacket.59(%rip), %xmm8
        subss     %xmm2, %xmm3
        movss     %xmm3, -24(%rsp)
        movss     -24(%rsp), %xmm4
        mulss     .LE32_2il0floatpacket.57(%rip), %xmm4
        movss     -24(%rsp), %xmm5
        subss     %xmm4, %xmm6
        mulss     .LE32_2il0floatpacket.58(%rip), %xmm5
        movswl    -20(%rsp), %ecx
        subss     %xmm5, %xmm6
        mulss     %xmm6, %xmm7
        addss     .LE32_2il0floatpacket.62(%rip), %xmm7
        mulss     %xmm6, %xmm7
        addss     .LE32_2il0floatpacket.61(%rip), %xmm7
        mulss     %xmm6, %xmm7
        addss     .LE32_2il0floatpacket.60(%rip), %xmm7
        mulss     %xmm6, %xmm7
        addss     %xmm8, %xmm7
        mulss     %xmm6, %xmm7
        addss     %xmm7, %xmm8
...
.LE32BL_2_7:
        ...
        movss     %xmm0, -16(%rsp)
        movss     -16(%rsp), %xmm1
        mulss     .LE32_2il0floatpacket.67(%rip), %xmm1
        movss     %xmm1, -16(%rsp)
        movl      -16(%rsp), %edi
        movl      %edi, (%rsi)
        ret
...
.LE32BL_2_8:
        ...
        movss     %xmm0, -16(%rsp)
        movss     -16(%rsp), %xmm1
        mulss     .LE32_2il0floatpacket.66(%rip), %xmm1
        movss     %xmm1, -16(%rsp)
        movl      -16(%rsp), %edx
        movl      %edx, (%rsi)
        ret
...
.LE32BL_2_9:
        ...
        movss     .LE32_2il0floatpacket.65(%rip), %xmm0
        mulss     %xmm0, %xmm0
        movss     %xmm0, -16(%rsp)
        movl      -16(%rsp), %eax
        movl      %eax, (%rsi)
...
.LE32BL_2_10:
        ...
        movss     .LE32_2il0floatpacket.54(%rip), %xmm0
        mulss     %xmm0, %xmm0
        movss     %xmm0, -16(%rsp)
        movl      -16(%rsp), %eax
        movl      %eax, (%rsi)
...
..LE32N__svml_sexp_cout_rare_internal.1:
...
__svml_sexp_data_internal_avx512:
	...
	.align 4
.LE32_2il0floatpacket.52:
	.long	0x42b17217
	.type	.LE32_2il0floatpacket.52,@object
	.size	.LE32_2il0floatpacket.52,4
	.align 4
.LE32_2il0floatpacket.53:
	.long	0xc2cff1b4
	.type	.LE32_2il0floatpacket.53,@object
	.size	.LE32_2il0floatpacket.53,4
	.align 4
.LE32_2il0floatpacket.54:
	.long	0x7f7fffff
	.type	.LE32_2il0floatpacket.54,@object
	.size	.LE32_2il0floatpacket.54,4
	.align 4
.LE32_2il0floatpacket.55:
	.long	0x3fb8aa3b
	.type	.LE32_2il0floatpacket.55,@object
	.size	.LE32_2il0floatpacket.55,4
	.align 4
.LE32_2il0floatpacket.56:
	.long	0x4b400000
	.type	.LE32_2il0floatpacket.56,@object
	.size	.LE32_2il0floatpacket.56,4
	.align 4
.LE32_2il0floatpacket.57:
	.long	0x3f317200
	.type	.LE32_2il0floatpacket.57,@object
	.size	.LE32_2il0floatpacket.57,4
	.align 4
.LE32_2il0floatpacket.58:
	.long	0x35bfbe8e
	.type	.LE32_2il0floatpacket.58,@object
	.size	.LE32_2il0floatpacket.58,4
	.align 4
.LE32_2il0floatpacket.59:
	.long	0x3f800001
	.type	.LE32_2il0floatpacket.59,@object
	.size	.LE32_2il0floatpacket.59,4
	.align 4
.LE32_2il0floatpacket.60:
	.long	0x3efffe85
	.type	.LE32_2il0floatpacket.60,@object
	.size	.LE32_2il0floatpacket.60,4
	.align 4
.LE32_2il0floatpacket.61:
	.long	0x3e2aa9c6
	.type	.LE32_2il0floatpacket.61,@object
	.size	.LE32_2il0floatpacket.61,4
	.align 4
.LE32_2il0floatpacket.62:
	.long	0x3d2bb1b6
	.type	.LE32_2il0floatpacket.62,@object
	.size	.LE32_2il0floatpacket.62,4
	.align 4
.LE32_2il0floatpacket.63:
	.long	0x3c0950ef
	.type	.LE32_2il0floatpacket.63,@object
	.size	.LE32_2il0floatpacket.63,4
	.align 4
.LE32_2il0floatpacket.64:
	.long	0xc2aeac4f
	.type	.LE32_2il0floatpacket.64,@object
	.size	.LE32_2il0floatpacket.64,4
	.align 4
.LE32_2il0floatpacket.65:
	.long	0x00000001
	.type	.LE32_2il0floatpacket.65,@object
	.size	.LE32_2il0floatpacket.65,4
	.align 4
.LE32_2il0floatpacket.66:
	.long	0x21800000
	.type	.LE32_2il0floatpacket.66,@object
	.size	.LE32_2il0floatpacket.66,4
	.align 4
.LE32_2il0floatpacket.67:
	.long	0x40000000
	.type	.LE32_2il0floatpacket.67,@object
	.size	.LE32_2il0floatpacket.67,4

      .section        .note.GNU-stack,"",@progbits

      .text
      .align 16
      .globl picvec_svml_expf16
picvec_svml_expf16:
      pushq %rbx
      movq %rsi, %rbx
      vmovups (%rdi), %zmm0
