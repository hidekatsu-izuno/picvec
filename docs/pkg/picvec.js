 ...
 * @returns {string}
 */
export function convert_image(input, maximum_dimension, remove_background) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.convert_image(retptr, ptr0, len0, maximum_dimension, remove_background);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('picvec_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
